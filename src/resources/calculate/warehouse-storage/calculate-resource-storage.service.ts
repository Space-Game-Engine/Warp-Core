import {BuildingZoneModel, BuildingZoneRepository, ResourceModel, WarehouseTypeEnum} from "@warp-core/database";
...
export class CalculateResourceStorageService {
    ...
    async calculateStorage(resource: ResourceModel): Promise<number> {
        ...
        const warehouses = await this.buildingZoneRepository.getWarehouseForResourceAndHabitat(resource, this.habitatModel.id);
