...
import {BuildingModel, BuildingZoneModel, ResourceTypeEnum} from "@warp-core/database";
...
describe('Simple calculation of resources for queue element', () => {
    ...
    describe.each(inputsToCalculateResources)('calculateResourcesCosts', (singleData) => {
        it(`'should return ${singleData.name}`, async () => {
            ...
            const queueCosts = await simpleCalculationService.calculateResourcesCosts(addToQueue, buildingZone, building);
