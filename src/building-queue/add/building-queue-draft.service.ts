...
import {DraftModelInterface, PrepareDraftModelServiceInterface} from "@warp-core/core/utils";
import {AddToQueueInput} from "@warp-core/building-queue/input/add-to-queue.input";
import {Injectable} from "@nestjs/common";

@Injectable()
export class BuildingQueueDraftService implements PrepareDraftModelServiceInterface {
    ...
    async getDraft(addToQueueElement: AddToQueueInput): Promise<DraftModelInterface> {
